...
@Unroll
@TestFor(AndsService)
class AndsServiceSpec extends Specification {

    AndsService service = new AndsService()
    ...
    def "generateRequestPayload should map all metadata fields to the ANDS xml schema"() {
        ...
        String expectedXml = new File("test/unit/resources/ValidANDSRequest.xml").text
